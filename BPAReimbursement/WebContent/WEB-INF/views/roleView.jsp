...
<html lang="en">
          	...
          	<h3><i class="fa fa-angle-right"></i>Roles</h3>
		  		<div class="row mt">
                      ...
                      <h4><i class="fa fa-angle-right"></i> Roles</h4>
                          ...
                          <section id="unseen">
                          <p align="right">
                          <a href="../role/addRole.action">
                          <button type="button" class="btn btn-primary">Add Role</button></a>&nbsp;&nbsp;
 ...
 <%
 	Integer roleId = (Integer)pageContext.getAttribute("roleId");	
 	String editurl="../role/editRole.action?roleId="+roleId;
	String deleteurl="../role/deleteRole.action?roleId="+roleId;
 %>
 <tr>
...
<button class="btn btn-danger btn-xs" onclick="location.href='<%=deleteurl %>';"><i class="fa fa-trash-o "></i></button></td>
       	...
       	<a href="../role/viewRoleList.action?page=${currentPage - 1}" class="myButton">Previous&nbsp;&nbsp;</a>
    </c:if>
    <%--For displaying Next link --%>
    <c:if test="${currentPage lt noOfPages}">
        <a href="../role/viewRoleList.action?page=${currentPage + 1}" class="myButton">Next&nbsp;&nbsp;</a>
    </c:if>
                        </div>  
