      ...
      <aside>
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="mt">
                      <a class="active" href="viewHome.action">
				  ...
				  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          <li><a  href="../projectMaster/viewProjectMasterList.action">Projects List</a></li>
                          <li><a  href="saveProjectMaster.action">Create Project</a></li>                          
                      </ul>
                  </li>
                  <li class="sub-menu">
                      <a href="javascript:;" >
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          ...
                          <li><a  href="../role/viewRoleList.action">Roles</a></li>
