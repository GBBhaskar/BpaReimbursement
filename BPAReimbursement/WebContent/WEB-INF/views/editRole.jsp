          ...
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
				  ...
				  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          <li><a  href="../projectMaster/viewProjectMasterList.action">Project List</a></li>
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          <li><a href="viewReimbursementList.action">Users</a></li>
                          <li><a  href="../role/viewRoleList.action">Roles</a></li>
                          <li><a  href="addDepartment.action">Departments</a></li>                         
                      </ul>
                  </li>
          ...
          <section class="wrapper">
          	...
          	<div class="row mt">
                  ...
                  <div class="form-panel">
                  	  <h4 class="mb"><i class="fa fa-angle-right"></i> Edit Role</h4>
                  	  <form:form modelAttribute="role" method="post" name="roleform" action="../role/saveRole.action">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-4">
                              	  <form:input path="roleDescription" id="roleDescription" class="form-control"/>
