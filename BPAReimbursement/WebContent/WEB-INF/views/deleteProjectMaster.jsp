...
<html lang="en">
  ...
  <section id="container" >
      ...
      *********************************************************************************************************************************************************** -->
		...
		<%-- <form:form modelAttribute="projectMaster" method="post" name="projectform">
		if(success){%>
  		<script>
	...
	<%}else{%>
  	<script>
		...
		<%}%> --%>
                  	 <%--  <h4 class="mb"><i class="fa fa-angle-right"></i> Delete Project</h4>
                  	  <form:form modelAttribute="projectMaster" method="post" name="projectform" action="../projectMaster/deleteProjectMaster.action">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-4">
                              	  <form:input path="projectDescription"  id="projectDescription" class="form-control"/>
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                              	 <form:checkbox path="isActive" id="isActive"/>
